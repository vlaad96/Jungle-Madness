...
j1Collision::j1Collision()
{
	...
	matrix[COLLIDER_FLOOR][COLLIDER_TROLL] = false;
	matrix[COLLIDER_FLOOR][COLLIDER_FLY] = false;
	...
	matrix[COLLIDER_DEADLY][COLLIDER_TROLL] = false;
	matrix[COLLIDER_DEADLY][COLLIDER_FLY] = false;
	...
	matrix[COLLIDER_PLATFORM][COLLIDER_TROLL] = false;
	matrix[COLLIDER_PLATFORM][COLLIDER_FLY] = false;
	...
	matrix[COLLIDER_ROOF][COLLIDER_TROLL] = false;
	matrix[COLLIDER_ROOF][COLLIDER_FLY] = false;
	...
	matrix[COLLIDER_PLAYER][COLLIDER_TROLL] = true;
	matrix[COLLIDER_PLAYER][COLLIDER_FLY] = true;
	...
	matrix[COLLIDER_CHECKPOINT][COLLIDER_TROLL] = false;
	matrix[COLLIDER_CHECKPOINT][COLLIDER_FLY] = false;

	matrix[COLLIDER_TROLL][COLLIDER_FLOOR] = true;
	matrix[COLLIDER_TROLL][COLLIDER_DEADLY] = false;
	matrix[COLLIDER_TROLL][COLLIDER_PLATFORM] = true;
	matrix[COLLIDER_TROLL][COLLIDER_ROOF] = false;
	matrix[COLLIDER_TROLL][COLLIDER_PLAYER] = true;
	matrix[COLLIDER_TROLL][COLLIDER_CHECKPOINT] = false;
	matrix[COLLIDER_TROLL][COLLIDER_TROLL] = false;
	matrix[COLLIDER_TROLL][COLLIDER_FLY] = false;

	matrix[COLLIDER_FLY][COLLIDER_FLOOR] = true;
	matrix[COLLIDER_FLY][COLLIDER_DEADLY] = false;
	matrix[COLLIDER_FLY][COLLIDER_PLATFORM] = true;
	matrix[COLLIDER_FLY][COLLIDER_ROOF] = true;
	matrix[COLLIDER_FLY][COLLIDER_PLAYER] = true;
	matrix[COLLIDER_FLY][COLLIDER_CHECKPOINT] = false;
	matrix[COLLIDER_FLY][COLLIDER_TROLL] = false;
	matrix[COLLIDER_FLY][COLLIDER_FLY] = false;
...
void j1Collision::DebugDraw()
{
	...
	while (item != NULL)
	{
		...
		case COLLIDER_CHECKPOINT: // cyan
			...
			break;
		case COLLIDER_TROLL: // brown
			App->render->DrawQuad(item->data->rect, 123, 82, 44, alpha);
			break;
		case COLLIDER_FLY: // dark red
			App->render->DrawQuad(item->data->rect, 129, 18, 18, alpha);
			break;
		}
		item = item->next;
	}
